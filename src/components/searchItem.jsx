  ...
  return (
    ...
    Free airport taxi</span>
      ...
      <div className="siDetails" style={{
        ...
        <div className="siDetailTexts" style={{
          textAlign: "right",
          display: "flex",
          flexDirection: "column",
          gap: "5px"
          ...
          <button className="siCheckButton" style={{
